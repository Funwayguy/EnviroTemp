...
public class JsonHelper
{
	...
	public static JsonObject ReadObjectFromFile(File file)
	{
		...
		{
			EnviroTemp.logger.log(Level.ERROR, "An error occured while loading JSON from file:", e);
	...
	public static void WriteToFile(File file, JsonElement json)
	{
		...
		{
			EnviroTemp.logger.log(Level.ERROR, "An error occured while saving JSON to file:", e);
			return;
		}
	}
}
